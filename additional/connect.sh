...
#message="$(echo -e "${common_name},${untrusted_ip},${untrusted_port},${ifconfig_pool_remote_ip},${time_ascii},${bytes_received}0,${bytes_sent}0,${IV_PLAT},${IV_GUI_VER},${IV_HWADDR},connected ")"
